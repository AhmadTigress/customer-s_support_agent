...
if __name__ == "__main__":
    ...
    tests = [
        ...
        "test_load_documents_success",
        "test_load_documents_missing_files",
        "test_load_documents_file_read_error",
        "test_load_documents_encoding_issues",
    ...
    print("DocumentLoader tests completed!")
